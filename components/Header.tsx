      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 bg-bzl-green">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <Link href="/" className="flex items-center cursor-pointer">
            <span
                className="self-center text-xl font-semibold whitespace-nowrap dark:text-white cursor-pointer">Bazel Central Registry</span>
          </Link>
          ...
          <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-2"
            ...
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <a href={USER_GUIDE_LINK}
                   className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-gray-300 md:p-0">Bzlmod User Guide</a>
              </li>
              <li>
                <a href={CONTRIBUTE_CTA_LINK}
                   className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-gray-300 md:p-0">Contribute to the BCR</a>
              </li>
            </ul>
          </div>
        </div>
